...
public:
    ...
    Grid::Octree<std::shared_ptr<PlantsimParticle>, uint8_t> grid = Grid::Octree<std::shared_ptr<PlantsimParticle>, uint8_t>(Vector3f::Constant(-128), Vector3f::Constant(128), "output/plant", 16);
    PlantConfig config;
    std::mt19937 rng;
